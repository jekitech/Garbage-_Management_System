<%-- 
    Document   : email
    Created on : Mar 28, 2020, 9:54:37 AM
    Author     : kebre
--%>
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" method="post" action="EmailSending">
                      <c:forEach var="details" items="${details}">
                    <div class="form-group ">
                      <label for="cemail" class="control-label col-lg-2">Recipient Address <span class="required">*</span></label>
                      <div class="col-lg-10">
                          <input class="form-control " id="cemail" type="email" name="recipient" value="${details.email}" required />
                      </div>
                    </div>
                 </c:forEach>
                    <div class="form-group ">
