          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                  ...
                  <form class="form-horizontal " method="post" action="UpdateRequest?id=${list.id}">
                   
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Location</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="${list.location}" name="location">
                    </div>
                  </div>
                  <div class="form-group">
                  </div>
                 ...
                 <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control ckeditor" name="editor1" rows="6">${list.description}</textarea>
                          </div>
                        </div>
