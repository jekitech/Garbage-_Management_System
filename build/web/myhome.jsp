<%-- 
    Document   : myhome
    Created on : Mar 1, 2020, 1:31:15 AM
    Author     : kebre
--%>
...
<html lang="en">
   ...
   <!-- end font family -->
   <link rel="stylesheet" href="css3/3dslider.css" />
   <script src="http://code.jquery.com/jquery-1.11.1.min.js"></script>
   <link href="http://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
   <script src="js3/3dslider.js"></script>
   </head>
               ...
               <div class="header-top">
                  <div class="row">
                     <div class="col-md-6">
                        <div class="full">
                           <div class="logo">
                              <a href="index.html"><img src="img/voke.jpg" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                              <li class="login-modal">
                                 <a href="auth.jsp" class="login"><i class="fa fa-user"></i>Login</a>
                              </li>
                              <li>
                                 <div class="cart-option">
                                    <a href="register.jsp"><i class="fa fa-shopping-cart"></i>Register</a>
                                 </div>
                              </li>
                           </ul>
                           <!-- end button section -->
                     ...
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                              <h3>You deserve the best<br>Don't <span class="color-yellow">settle for nothing</span><br>but quality!</h3>
                              <p>
                                  Looking to solve your waste puzzle? then join us today and you will never regret!
                              </p>
