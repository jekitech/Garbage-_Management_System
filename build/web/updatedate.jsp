<%-- 
    Document   : updatedate
    Created on : Mar 25, 2020, 9:10:36 PM
    Author     : kebre
--%>
...
<body>
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                Update Date of Collection
              </header>
              <div class="panel-body">
                <div class="form">
                    <c:forEach var="id" items="${id}">
                  <form class="form-validate form-horizontal" method="post" action="UpdateDate?id=${id}">
                      
                    <div class="form-group ">
                      <label for="date" class="control-label col-lg-2">Date <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="date" name="date" minlength="5" type="date" required />
                      </div>
                    </div>
  ...
  <script type="text/javascript"> var Msg = '<%=session.getAttribute("getalert")%>';
                          if(Msg != "null"){
                              function alertName(){
                                  alert("Collection date has been updated successfully");
                              }
                          }
