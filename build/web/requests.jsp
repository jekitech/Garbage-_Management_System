        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
                ...
                <tbody>
                  <tr>
                    <th><i class="icon_calendar"></i> Date of the request</th>
                    <th><i class="icon_pin_alt"></i> Location</th>
                    <th><i class="icon_mobile"></i> Estimated Quantity</th>
                    <th><i class="icon_calendar"></i> Collection date</th>
                    <th><i class="icon_cogs"></i> Action</th>
                    <th><i class="icon_mobile"></i>Picked</th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <fmt:parseDate var="date1" value="2020-03-13" pattern="yyy-mm-dd"/>
                    <fmt:parseDate var="date2" value='${show.collection_date}' pattern="yyy-mm-dd" />
                    
                    <c:choose>
                        <c:when test="${date2 eq date1}">
                            <td>----</td>
                        </c:when>
                        <c:otherwise>
                            <td>${show.collection_date}</td>
                        </c:otherwise>
                    </c:choose>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="Edit_Request?id=${show.id}"><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-danger" href="Cancel_Request?id=${show.id}"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                    <td>
                        
                        <c:choose>
                        <c:when test="${show.status=='1'}">
                          <div class="btn-group">
                        ...
                        <c:otherwise>
                            ...
                            <a class="btn btn-success" href="UpdateStatus?id=${show.id}"><input type="checkbox" value=""></a>
