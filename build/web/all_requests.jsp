            ...
            <section class="panel">
                ...
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_calendar"></i> Date of Collection</th>
                    <th><i class="icon_cogs"></i> Picked</th>
                    <th><i class="icon_mail_alt" id="email"></i> Send Response</th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <fmt:parseDate var="date2" value='${show.collection_date}' pattern="yyy-mm-dd" />
                     ...
                     <c:choose>
                        <c:when test="${date2 eq date1}">
                         <td><a href="UpdateDate?id=${show.id}">---------</a></td>
                        </c:when>
                        <c:otherwise>
                       ...
                       <c:choose>
                        ...
                        <c:otherwise>
                            <div class="btn-group">
                                ...
                                <a class="btn btn-success" href=""><input type="checkbox" value="" disabled=""></a>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-success" href="Getemail?username=${show.username}"><i class="icon_mail_alt"></i></a>
                      </div>
                    </td>
